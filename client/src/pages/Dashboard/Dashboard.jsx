...
//         <p style={{ fontSize: "1rem", color: "#475569", marginTop: "6px" }}>Overview of academic activities, messages, and events.</p>
//       </section>

//       {/* Notifications & Upcoming Events at Top */}
...
//       {/* Main layout: single column (stats, cards, chart, recent activity) */}
//       <div>
//         {/* Stats */}
...
// import React, { useState } from "react";
// import { useNavigate } from "react-router-dom";
// import { BookOpen, Presentation, Users, FileText, Bell, MessageCircle, Calendar } from "lucide-react";
// import {
//   LineChart,
//   Line,
//   XAxis,
...
//     { title: "Faculty Online Today", value: 18, color: "#38bdf8" },
//   ];
...
//       {/* FDP Completion Progress */}
//       <section style={{ marginBottom: "20px" }}>
//         <h2 style={{ fontSize: "1.5rem", fontWeight: "600", marginBottom: "15px", color: "#1e293b" }}>FDP Completion Status</h2>
//         <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
//           <div style={{ display: "flex", justifyContent: "space-between" }}>
//             <span>FDPs Attended</span>
//             <span>80%</span>
//           </div>
//           <div style={{ height: "10px", background: "#e5e7eb", borderRadius: "6px" }}>
//             <div style={{ width: "80%", height: "100%", background: "#34d399", borderRadius: "6px" }}></div>
//           </div>

//           <div style={{ display: "flex", justifyContent: "space-between" }}>
//             <span>FDPs Conducted</span>
//             <span>60%</span>
//           </div>
//           <div style={{ height: "10px", background: "#e5e7eb", borderRadius: "6px" }}>
//             <div style={{ width: "60%", height: "100%", background: "#fbbf24", borderRadius: "6px" }}></div>
//           </div>
//         </div>
//       </section>
...
//       {/* Top Contributors */}
//       <section style={{ marginBottom: "20px" }}>
//         <h2 style={{ fontSize: "1.5rem", fontWeight: "600", marginBottom: "15px", color: "#1e293b" }}>Top Contributors</h2>
//         <div style={{ display: "flex", gap: "15px", flexWrap: "wrap" }}>
//           {topContributors.map((faculty, idx) => (
//             <div key={idx} style={{ background: "#fff", padding: "15px", borderRadius: "12px", boxShadow: "0 8px 20px rgba(0,0,0,0.05)", flex: "1 1 150px", textAlign: "center" }}>
//               <h3 style={{ fontWeight: "600", color: "#1e293b" }}>{faculty.name}</h3>
//               <p style={{ fontSize: "0.9rem", color: "#6b7280" }}>{faculty.fdp} FDPs</p>
//             </div>
//           ))}
//         </div>
//       </section>

//       {/* Latest Reports / Templates */}
//       <section style={{ marginBottom: "20px" }}>
//         <h2 style={{ fontSize: "1.5rem", fontWeight: "600", marginBottom: "15px", color: "#1e293b" }}>Latest Reports / Templates</h2>
//         <ul style={{ listStyle: "none", padding: 0 }}>
//           {latestReports.map((report, idx) => (
//             <li key={idx} style={{ background: "#fff", padding: "12px 15px", borderRadius: "10px", marginBottom: "10px", boxShadow: "0 5px 15px rgba(0,0,0,0.05)", display: "flex", justifyContent: "space-between" }}>
//               <span>{report.title}</span>
//               <span style={{ color: "#6b7280" }}>{report.date}</span>
//             </li>
//           ))}
//         </ul>
//       </section>
...
//       {/* Motivational Quote */}
//       <section>
//         <div style={{ background: "#60a5fa", color: "#fff", borderRadius: "12px", padding: "15px", textAlign: "center", fontWeight: "500" }}>
//           "Consistency is the key to excellence. Keep attending and conducting FDPs!"
//         </div>
//       </section>
//     </div>
//   );
